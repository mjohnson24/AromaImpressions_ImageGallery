...
function convertClipboardToFM() {
  exec("osascript -e 'set the clipboard to (do shell script \"pbpaste\" as «class XMSS»)'", (error) => {
    if (error) {
...
console.log("\x1b[32mConverted to script steps. Go paste it in your FM script!\x1b[0m");
